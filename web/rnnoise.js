...
// NOTE: the upstream @jitsi/rnnoise-wasm dist ends with
// `export default createRNNWasmModule;`, which makes it an ES module. We load
// it as a classic <script> (so `createRNNWasmModule` becomes a global that
// rnnoise_denoise.js can use), and a classic script throws on `export` — so
// that line is intentionally removed here.