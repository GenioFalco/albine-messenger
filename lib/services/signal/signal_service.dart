...
class SignalService {
  ...
  Future<void> ensureBootstrapped(Uint8List identitySecretKeyBytes) async {
  ...
  Future<SignalMessageEnvelope?> encryptForContact(AppProfile peer, Uint8List plaintext) async {
  ...
  Future<Uint8List> decryptFromContact(String peerId, Uint8List ciphertext, int messageType) async {
